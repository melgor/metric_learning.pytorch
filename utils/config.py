...
_C.MODEL.BACKBONE.OUT_FEATURES = 2048
...
# Loss
_C.LOSSES = CN()
_C.LOSSES.NAME = 'TripletLoss'
_C.LOSSES.MINING = 'TripletHard'


# triplet_loss
_C.LOSSES.TRIPLET_LOSS = CN()
_C.LOSSES.TRIPLET_LOSS.MARGIN = 0.2
_C.LOSSES.TRIPLET_LOSS.NON_ZERO = True
_C.LOSSES.TRIPLET_LOSS.NORMALIZE = False


# mining-triplet hard
_C.LOSSES.TRIPLET_MINING = CN()
_C.LOSSES.TRIPLET_MINING.MARGIN = 0.2
_C.LOSSES.TRIPLET_MINING.NORMALIZE = True
...
# Data option
_C.DATA = CN()
_C.DATA.DATA_ROOT = "/home/blcv/CODE/MetricLearning/datasets"
_C.DATA.IMG_SOURCE = "CUB_200_2011"
_C.DATA.TRAIN_BATCHSIZE = 48
_C.DATA.TEST_BATCHSIZE = 64
_C.DATA.SAMPLER = "IdentitySampler"
...
# Logger
_C.LOGGER = CN()
_C.LOGGER.OUTPUT = "log.txt"
_C.LOGGER.NAME = 'metric.learning'

# Validation
_C.VALIDATION = CN()
_C.VALIDATION.TEST_TRAIN = True
...
# _C.SOLVER = CN()
#
# # See detectron2/solver/build_losses.py for LR scheduler options
